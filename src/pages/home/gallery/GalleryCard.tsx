...
const GalleryCard = ({ image }: { image: string }) => {
  return (
    <div className="rounded-lg relative group overflow-hidden">
      ...
      />
      <div className="bg-primary bg-opacity-90 absolute inset-0 rounded-lg m-4 p-8 flex flex-col justify-between opacity-0 group-hover:opacity-100 transition-all">
        ...
        <p className=" border-2 border-white w-fit rounded-full p-[2px] mt-10 ml-10 group-hover:mt-0 group-hover:ml-0 delay-75 transition-all ">
          <Plus className="size-12 rounded-full bg-white p-1 text-primary" />
        </p>
        {/* </p> */}
